    ...
    <section className="mb-12" id="doppia-materialita">
      ...
      <div className="prose max-w-none">
        <p className="mb-6 text-lg">
          La Corporate Sustainability Reporting Directive (CSRD) rappresenta un'evoluzione significativa rispetto alla Non-Financial Reporting Directive (NFRD), con l'obiettivo di rafforzare e ampliare gli obblighi di rendicontazione sulla sostenibilità delle imprese. Ecco le principali differenze:
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Ambito di applicazione</h3>
        <p className="mb-2 text-lg">L'ambito di applicazione della CSRD è significativamente più ampio rispetto alla NFRD:</p>
        
        <p className="mb-6 text-lg">
          La NFRD si applicava a circa 11.600 società, principalmente grandi enti di interesse pubblico (EIP) con più di 500 dipendenti, tra cui società quotate, banche e compagnie assicurative.
        </p>
        
        <p className="mb-2 text-lg">La CSRD estenderà l'obbligo di rendicontazione a circa 49.000 aziende, includendo:</p>
        ...
        <p className="mb-2 text-lg">La CSRD introduce standard di reporting più dettagliati e rigorosi:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Livello di dettaglio delle informazioni</h3>
        <p className="mb-2 text-lg">Il livello di dettaglio richiesto è significativamente aumentato:</p>
        
        <p className="mb-6 text-lg">
          La NFRD richiedeva informazioni su ambiti generali come protezione dell'ambiente, responsabilità sociale, trattamento dei dipendenti, diritti umani, lotta alla corruzione e diversità nei consigli di amministrazione.
        </p>
        
        <p className="mb-2 text-lg">La CSRD richiede informazioni molto più dettagliate, includendo:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Assurance esterna</h3>
        <p className="mb-2 text-lg">Un'altra differenza fondamentale riguarda la verifica esterna:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Tempistiche di applicazione</h3>
        <p className="mb-2 text-lg">L'implementazione della CSRD avverrà gradualmente:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">La doppia materialità nella CSRD</h3>
        <p className="mb-6 text-lg">
          Uno degli elementi più innovativi introdotti dalla CSRD è il concetto di "doppia materialità", che amplia significativamente l'approccio alla rendicontazione della sostenibilità.
        </p>
        
        <h4 className="text-xl font-semibold mb-3">Definizione di doppia materialità</h4>
        <p className="mb-2 text-lg">La doppia materialità richiede alle aziende di considerare due prospettive distinte ma interconnesse:</p>
        ...
        <h4 className="text-xl font-semibold mb-3">Origine della doppia materialità</h4>
        <p className="mb-6 text-lg">
          Il concetto di doppia materialità è stato formalmente introdotto e definito dalla Commissione Europea nell'ambito del suo lavoro sulla finanza sostenibile e la rendicontazione non finanziaria, in particolare con l'aggiornamento della NFRD. È stato poi consolidato e reso obbligatorio con l'introduzione della CSRD.
        </p>
        
        <h4 className="text-xl font-semibold mb-3">Applicazione pratica della doppia materialità</h4>
        <p className="mb-2 text-lg">In pratica, l'applicazione della doppia materialità richiede alle aziende di:</p>
        ...
        <p className="mb-2 text-lg">Un esempio concreto di doppia materialità per un'azienda agroalimentare:</p>
        ...
        <p className="mb-6 text-lg">
          L'implementazione della doppia materialità rappresenta un cambio di paradigma nella rendicontazione aziendale, spingendo le organizzazioni a considerare non solo come i rischi ESG influenzano i loro risultati economici, ma anche come le loro attività impattano sul mondo esterno, promuovendo una maggiore responsabilità e trasparenza.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Processo di applicazione della doppia materialità</h3>
        <p className="mb-2 text-lg">L'EFRAG ha pubblicato linee guida dettagliate per condurre l'analisi di doppia materialità, strutturata in quattro fasi principali:</p>
        ...
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
          ...
          <li><strong>FASE C - Valutazione della materialità:</strong> Si valuta separatamente la rilevanza d'impatto e la rilevanza finanziaria:
            <ul className="list-disc pl-8 mt-2 text-lg space-y-1">
        ...
        <h3 className="text-2xl font-semibold mb-4">Integrazione con la gestione del rischio aziendale</h3>
        <p className="mb-6 text-lg">
          L'analisi di doppia materialità si integra con il risk management aziendale già esistente. Questo collegamento è particolarmente rilevante considerando le normative nazionali come l'art. 2086 del Codice Civile, che impone alle imprese di analizzare i rischi potenziali, e l'art. 242, che richiede la rendicontazione di tali rischi.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Sanzioni per inadempienza alla CSRD</h3>
        <p className="mb-2 text-lg">La CSRD prevede che gli Stati membri stabiliscano sanzioni "efficaci, proporzionate e dissuasive" per le aziende che non rispettano gli obblighi di rendicontazione. In Italia, il recente recepimento della direttiva da parte del Consiglio dei Ministri (30 agosto 2024) ha stabilito che:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Formato elettronico dei dati</h3>
        <p className="mb-6 text-lg">
