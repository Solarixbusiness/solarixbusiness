    ...
    <div id="kpi-indicatori" className="bg-white rounded-lg shadow-lg p-8 mb-8">
      ...
      <div className="prose max-w-none">
        <p className="mb-6 text-lg">
          Secondo lo studio condotto dal Forum per la Finanza Sostenibile in collaborazione con ALTIS Università Cattolica, le PMI italiane che redigono documenti di sostenibilità si concentrano principalmente su diverse aree tematiche, ciascuna con specifici indicatori.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Aree tematiche più rendicontate</h3>
        <p className="mb-6 text-lg">
          L'83% delle PMI italiane che pubblicano report di sostenibilità rendicontano almeno una tematica sociale, mentre il 78% si concentra sugli aspetti ambientali e il 74% sugli aspetti di governance. Questa distribuzione è interessante perché, sebbene gli interventi pratici delle PMI tendano a privilegiare l'ambito ambientale, nella rendicontazione emerge una leggera prevalenza degli aspetti sociali.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Indicatori sociali</h3>
        <p className="mb-2 text-lg">Gli indicatori sociali più frequentemente rendicontati dalle PMI italiane sono:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Indicatori ambientali</h3>
        <p className="mb-2 text-lg">Per quanto riguarda gli indicatori ambientali, si nota un divario significativo tra:</p>
        ...
        <p className="mb-6 text-lg">
          Questo divario suggerisce che molte PMI italiane hanno ancora difficoltà ad adottare metodologie di rilevazione e inventariazione delle emissioni complete, nonostante la crescente importanza della rendicontazione climatica.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Indicatori di governance</h3>
        <p className="mb-2 text-lg">Per l'area governance, si evidenziano due principali categorie di indicatori:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Altri ambiti di rendicontazione</h3>
        <p className="mb-2 text-lg">Oltre alle tre aree ESG tradizionali, le PMI italiane rendicontano anche:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Framework di rendicontazione utilizzati</h3>
        <p className="mb-6 text-lg">
          Il 70% delle PMI italiane che pubblicano report di sostenibilità adotta i GRI (Global Reporting Initiative) Standard, principalmente nella versione "Core" (68% dei casi), mentre l'opzione estesa "Comprehensive" risulta marginale (7%). Altri standard utilizzati includono SASB (14%), B Impact Assessment (9% per le B Corp) e International Integrated Reporting Framework di IIRC (7%).
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Dettaglio dei 15 KPI fondamentali per la rendicontazione</h3>
        <p className="mb-6 text-lg">
          Secondo fonti più recenti, esistono 15 KPI specifici che vengono considerati fondamentali per una rendicontazione di sostenibilità efficace anche a misura di PMI, suddivisi nelle seguenti categorie:
        </p>
        
        <h4 className="text-xl font-semibold mb-3">KPI ambientali fondamentali</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-3">KPI sociali fondamentali</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-3">KPI di governance fondamentali</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-3">KPI di risk management, compliance e strategia</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h3 className="text-2xl font-semibold mb-4">Nuovi indicatori per il dialogo con le banche</h3>
        <p className="mb-2 text-lg">
          Recentemente, il Ministero dell'Economia e delle Finanze ha sviluppato un documento di 45 indicatori di sostenibilità specificamente pensati per facilitare il dialogo tra PMI e banche. Questi indicatori sono stati successivamente ridotti a 40 dopo una consultazione pubblica e sono organizzati in 5 filoni principali:
        </p>
