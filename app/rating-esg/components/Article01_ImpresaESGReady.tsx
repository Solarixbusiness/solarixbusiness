  ...
  return (
    <div id="impresa-esg-ready" className="bg-white rounded-lg shadow-lg p-8 mb-8">
      ...
      <div className="prose max-w-none">
        <h3 className="text-2xl font-semibold mt-8 mb-4">Cos'è la Direttiva CSRD e il suo contesto normativo</h3>
        ...
        <p className="mb-2 text-lg">Sebbene la CSRD possa essere vista inizialmente come un ulteriore onere normativo, rappresenta in realtà un'opportunità strategica per le aziende:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <p className="mb-2 text-lg">Se hai bisogno di supporto per adeguarti alla CSRD e sviluppare un report di sostenibilità efficace, SOLARIXBUSINESS mette a disposizione un team di consulenti specializzati che possono affiancarti in ogni fase del processo:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <p className="mb-2 text-lg">Comprendere le differenze tra i vari standard di rendicontazione aiuta a scegliere quello più adatto alle esigenze della propria azienda:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
