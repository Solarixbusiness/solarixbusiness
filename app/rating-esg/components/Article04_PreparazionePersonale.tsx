  ...
  return (
    <section className="mb-12" id="preparazione-personale">
      ...
      <div className="prose max-w-none">
        ...
        <p className="mb-6 text-lg">
          Inoltre, è consigliabile valutare la possibilità di assumere consulenti esterni o esperti del settore per fornire formazione specializzata e guidare l'azienda nelle fasi iniziali della transizione. Questi professionisti possono portare competenze specialistiche e best practices derivanti da esperienze con altre organizzazioni.
        </p>
        
        <p className="mb-6 text-lg">
          Infine, è cruciale monitorare costantemente i progressi e adattare il piano di formazione in base alle esigenze emergenti e ai feedback ricevuti dal personale. La transizione verso una rendicontazione integrata è un processo continuo che richiede aggiornamenti e miglioramenti costanti.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Percorsi formativi specifici e normative</h3>
        <p className="mb-6 text-lg">
          Per completare la preparazione del personale, è possibile considerare percorsi formativi professionali specifici come quelli per ESG Advisor e ESG Auditor, riconosciuti dal Comitato Ecolabel Ecoaudit di ISPRA. Questi percorsi sono particolarmente rilevanti per chi dovrà occuparsi della verifica e validazione dei claim etici di sostenibilità secondo standard come UNI/IEC 17029 e UNI/TS 17033:2020.
        </p>
        
        <p className="mb-6 text-lg">
          Inoltre, programmi formativi come l'ESG Management del Sole 24 ORE consentono di sviluppare competenze avanzate per l'integrazione dei temi di sostenibilità nelle strategie aziendali. Questo tipo di formazione è particolarmente importante in quanto riconosciuto come abilitante all'ottenimento dei 40 crediti formativi necessari per accedere all'esame come Sustainability Manager e Sustainability Practitioner secondo la prassi di riferimento UNI/PdR 109.1:2021.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Tempistiche di applicazione della CSRD</h3>
        <p className="mb-2 text-lg">È fondamentale pianificare la formazione considerando il calendario di applicazione della CSRD, che prevede scadenze differenziate:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Focus sulla doppia materialità</h3>
        <p className="mb-6 text-lg">
        ...
        <h3 className="text-2xl font-semibold mb-4">Strumenti tecnologici per la rendicontazione</h3>
        <p className="mb-2 text-lg">La formazione dovrebbe includere l'utilizzo di strumenti tecnologici che facilitano la rendicontazione di sostenibilità, come:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
