  ...
  return (
    <section className="mb-12" id="best-practice">
      ...
      <div className="prose max-w-none">
        ...
        <h4 className="text-xl font-semibold mb-3">Adozione di Sustainability Loan</h4>
        <p className="mb-6 text-lg">
          Alcune PMI italiane stanno accedendo ai nuovi Sustainability Loan (S-Loan), lanciati da alcuni gruppi bancari per supportare la trasformazione sostenibile delle piccole e medie imprese. Questi strumenti finanziari rappresentano un'importante opportunità per sostenere gli investimenti in sostenibilità.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Vantaggi dell'Adozione degli Standard</h3>
        <p className="mb-2 text-lg">L'adeguamento agli standard ESRS può portare vantaggi significativi alle PMI italiane, tra cui:</p>
        ...
        <p className="mb-6 text-lg">
          Le aziende che hanno già implementato queste pratiche dimostrano che la rendicontazione di sostenibilità non è solo un obbligo normativo ma anche un'opportunità di miglioramento e innovazione.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Quadro Normativo e Responsabilità</h3>
        <p className="mb-6 text-lg">
          La Direttiva CSRD è stata recepita in Italia con il D. Lgs 125/2024, entrato in vigore il 25 settembre 2024. Questa normativa introduce l'obbligo di rendicontazione in conformità agli European Sustainability Reporting Standards (ESRS), con importanti implicazioni anche per le PMI che, pur non essendo direttamente soggette all'obbligo, devono prepararsi per rispondere alle richieste informative delle società obbligate e delle banche.
        </p>
        
        <h4 className="text-xl font-semibold mb-3">Responsabilità e Sanzioni</h4>
        <p className="mb-2 text-lg">Il D. Lgs 125/2024 definisce precise responsabilità per gli organi amministrativi e di controllo delle imprese:</p>
        ...
        <p className="mb-6 text-lg">
          Per i primi due anni successivi all'entrata in vigore del decreto, è previsto un regime sanzionatorio graduale con limiti alle sanzioni amministrative e pecuniarie.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Esempi di PMI Italiane Virtuose</h3>
        <p className="mb-6 text-lg">
          Alcune PMI italiane hanno già adottato pratiche di rendicontazione di sostenibilità con risultati significativi:
        </p>
        
        <h4 className="text-xl font-semibold mb-3">OEB Brugola 1926</h4>
        <p className="mb-6 text-lg">
          L'azienda del settore meccanico ha abbracciato la sostenibilità attraverso il bilancio di sostenibilità, investendo in tecnologie eco-sostenibili ed energia rinnovabile, riducendo significativamente le emissioni di carbonio e promuovendo la sostenibilità lungo la catena di approvvigionamento.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Approccio Pratico alla Rendicontazione</h3>
        <p className="mb-2 text-lg">Per le PMI che desiderano iniziare il percorso verso la rendicontazione di sostenibilità, si consiglia una roadmap in cinque fasi:</p>
