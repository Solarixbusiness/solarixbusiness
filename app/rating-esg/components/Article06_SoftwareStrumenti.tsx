  ...
  return (
    <section className="mb-12" id="software-strumenti">
      ...
      <div className="prose max-w-none">
        <h3 className="text-2xl font-semibold mb-4">Piattaforme Software ESG Dedicate</h3>
        <p className="mb-2 text-lg">Esistono numerosi software specializzati nella raccolta dati e redazione di report di sostenibilità, conformi agli standard normativi come la direttiva CSRD:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Tecnologie di Supporto alla Rendicontazione</h3>
        <p className="mb-2 text-lg">Oltre ai software dedicati, diverse tecnologie possono supportare il processo di rendicontazione:</p>
        
        <h4 className="text-xl font-semibold mb-2">Blockchain</h4>
        <p className="mb-6 text-lg">
          Offre notevoli vantaggi nella gestione dei bilanci di sostenibilità aziendale, tracciando ogni transazione e attività legata alla sostenibilità, garantendo trasparenza e immutabilità dei dati.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">Big Data e Analytics</h4>
        <p className="mb-6 text-lg">
          Strumenti di analisi dei dati permettono di elaborare grandi quantità di informazioni ambientali, sociali e di governance per ricavarne insight significativi. L'analisi big data supporta la conoscenza dettagliata degli effetti ambientali dei processi aziendali.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">Intelligenza Artificiale e Machine Learning</h4>
        <p className="mb-6 text-lg">
          Queste tecnologie possono automatizzare l'analisi dei dati, identificare pattern e ottimizzare i processi di sostenibilità, riducendo il lavoro manuale nella raccolta e organizzazione dei dati ESG.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">Internet of Things (IoT)</h4>
        <p className="mb-6 text-lg">
          Sensori e dispositivi connessi che raccolgono dati in tempo reale su consumi energetici, emissioni e altri parametri ambientali, facilitando un monitoraggio continuo e preciso.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">Cloud Computing</h4>
        <p className="mb-6 text-lg">
          Soluzioni cloud che permettono di centralizzare la raccolta dati, migliorare l'accessibilità delle informazioni e ridurre il consumo di risorse fisiche per l'archiviazione.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">Dashboard Interattive</h4>
        <p className="mb-6 text-lg">
          Strumenti di visualizzazione che trasformano i dati complessi in rappresentazioni grafiche facilmente comprensibili per stakeholder interni ed esterni.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Benefici della Digitalizzazione del Processo di Rendicontazione</h3>
        <p className="mb-2 text-lg">L'adozione di strumenti digitali per la rendicontazione di sostenibilità offre numerosi vantaggi:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Funzionalità Specifiche di Workiva per CSRD</h3>
        <p className="mb-2 text-lg">Workiva offre funzionalità avanzate specifiche per la rendicontazione CSRD:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Le Quattro Tecnologie Chiave per gli ESG Reporting Tool</h3>
        <p className="mb-2 text-lg">Secondo l'analisi degli esperti, quattro tecnologie emergono come essenziali per gli strumenti di reporting ESG:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Evoluzioni Future della Rendicontazione ESG</h3>
        <p className="mb-2 text-lg">La rendicontazione ESG sta evolvendo rapidamente verso:</p>
