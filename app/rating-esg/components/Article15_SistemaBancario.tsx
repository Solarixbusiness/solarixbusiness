    ...
    <div id="sistema-bancario" className="bg-white rounded-lg shadow-lg p-8 mb-8">
      ...
      <div className="prose max-w-none">
        <p className="mb-6 text-lg">
          Il sistema bancario italiano sta attraversando una trasformazione significativa per integrare la valutazione dei fattori ESG (Environmental, Social, Governance) nelle proprie politiche creditizie, con particolare attenzione alle PMI che rappresentano il tessuto produttivo fondamentale del paese.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Il "Dialogo di Sostenibilità tra PMI e Banche"</h3>
        <p className="mb-6 text-lg">
          Il Ministero dell'Economia e delle Finanze (MEF) ha sviluppato un documento chiamato "Dialogo di Sostenibilità tra PMI e Banche" che rappresenta un punto di svolta in questo processo. Questo documento, pubblicato nella sua versione definitiva il 6 dicembre 2024 dopo una consultazione pubblica durata dal 24 giugno al 2 agosto 2024, mira a supportare le PMI nella produzione di informazioni relative ai fattori ESG per facilitare il dialogo con gli istituti di credito.
        </p>
        
        <p className="mb-2 text-lg">Nella sua versione finale, il documento ha ridotto gli indicatori ESG da 45 a 40, semplificando alcune informazioni considerate troppo complesse per le PMI. Gli indicatori sono organizzati in cinque sezioni principali:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Impatti sulle PMI e accesso al credito</h3>
        <p className="mb-6 text-lg">
          Questa evoluzione sta già producendo effetti tangibili. Uno studio recente ha rivelato che le PMI con un elevato livello di adeguatezza ESG hanno beneficiato di un tasso di erogazione dell'11% più alto rispetto alla media. Inoltre, le imprese che adottano standard ESG elevati presentano un tasso di insolvenza inferiore del 34% rispetto alla media.
        </p>
        
        <p className="mb-2 text-lg">Per le PMI italiane, spesso caratterizzate da una scarsa capitalizzazione e da una forte dipendenza dal credito bancario, l'adozione di pratiche sostenibili sta diventando un fattore decisivo per:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Approccio proporzionale e semplificazione</h3>
        <p className="mb-6 text-lg">
          Un aspetto centrale dell'approccio italiano è la proporzionalità: l'implementazione sarà graduale, con 17 parametri considerati prioritari su cui si devono concentrare in particolare le micro imprese. Il MEF ha inoltre dato la possibilità alle PMI di fornire stime qualitative per alcune informazioni complesse, come quelle relative alla tassonomia UE.
        </p>
        
        <p className="mb-6 text-lg">
          Questo modello di riferimento standardizzato mira a ridurre gli oneri amministrativi e a semplificare il dialogo tra banche e imprese, risolvendo una criticità diffusa: la diversificazione dei questionari ESG richiesti dagli istituti. Le imprese con più rapporti bancari spesso affrontano richieste simili ma disomogenee, con un notevole dispendio di risorse.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Il tavolo per la finanza sostenibile</h3>
        <p className="mb-6 text-lg">
          Il "Dialogo di Sostenibilità tra PMI e Banche" è stato elaborato dal "Tavolo per la Finanza Sostenibile", un'iniziativa promossa dal MEF alla fine del 2022 che coinvolge il Ministero dell'Ambiente e della Sicurezza Energetica, la Banca d'Italia, la CONSOB, l'IVASS e la COVIP. Questo tavolo mira a favorire la mobilizzazione delle risorse private attraverso il mercato dei capitali a supporto della transizione ecologica in Italia, nel quadro degli impegni europei e internazionali.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Valutazione dei rischi ESG nelle banche</h3>
        <p className="mb-2 text-lg">Secondo le disposizioni dell'EBA, le banche dovranno identificare tre categorie di rischio legate alla sostenibilità:</p>
        ...
        <h3 className="text-2xl font-semibold mb-4">Certificazioni utili per le PMI</h3>
        <p className="mb-2 text-lg">Le PMI possono migliorare il proprio profilo ESG ottenendo alcune certificazioni riconosciute:</p>
