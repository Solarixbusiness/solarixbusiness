  ...
  return (
    <div id="reporting-integrato" className="bg-white rounded-lg shadow-lg p-8 mb-8">
      ...
      <div className="prose max-w-none">
        <h3 className="text-2xl font-semibold mb-4">Contesto normativo italiano ed europeo</h3>
        <p className="mb-2 text-lg">Le aziende italiane devono adeguarsi alla Direttiva UE 2022/2464 (Corporate Sustainability Reporting Directive - CSRD) che modifica la precedente direttiva sulla rendicontazione non finanziaria e amplia il campo di applicazione. Secondo questa normativa:</p>
        ...
        <p className="mb-6 text-lg">
          La CSRD verrà recepita nella legge italiana attraverso l'aggiornamento della Legge sulla Contabilità (Legge n. 431/2002) nella prima metà del 2024.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Strategie pratiche per l'integrazione</h3>
        
        <h4 className="text-xl font-semibold mb-2">1. Stabilire un quadro strategico per la sostenibilità</h4>
        <p className="mb-2 text-lg">Per un'integrazione efficace, è fondamentale:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-2">2. Integrare i processi di raccolta dati</h4>
        <p className="mb-2 text-lg">Un aspetto critico dell'integrazione è la raccolta e la gestione efficiente dei dati ESG:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-2">3. Sviluppare un report integrato</h4>
        <p className="mb-2 text-lg">L'integrazione del bilancio finanziario e di sostenibilità richiede di valutare l'impatto delle iniziative ESG sul modello di business. È necessario:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-2">4. Verifica e assurance</h4>
        <p className="mb-2 text-lg">La CSRD introduce l'obbligo di limited assurance sulle informazioni di sostenibilità nel primo anno di reporting secondo CSRD/ESRS. Come parte di questa verifica, il revisore valuta:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h3 className="text-2xl font-semibold mb-4">Framework e standard ESG disponibili</h3>
        <p className="mb-2 text-lg">Per la rendicontazione ESG, le aziende italiane possono utilizzare diversi framework e standard, tra cui:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h3 className="text-2xl font-semibold mb-4">Benefici dell'integrazione ESG-finanza</h3>
        <p className="mb-2 text-lg">L'integrazione della reportistica ESG con quella finanziaria offre numerosi vantaggi:</p>
        
        <h4 className="text-xl font-semibold mb-2">Benefici interni</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-2">Benefici esterni</h4>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h3 className="text-2xl font-semibold mb-4">Framework di rendicontazione più diffusi</h3>
        <p className="mb-2 text-lg">Per integrare efficacemente la reportistica ESG con i sistemi tradizionali, è importante comprendere i principali modelli disponibili:</p>
        
        <h4 className="text-xl font-semibold mb-2">1. Sustainability Accounting Standards Board (SASB)</h4>
        <p className="mb-6 text-lg">
          Il SASB è un'organizzazione senza scopo di lucro nata nel 2011 che fornisce un quadro normativo specifico per settore, evidenziando gli standard maggiormente rilevanti per gli investitori in quanto materialmente impattanti sul business. Copre 77 settori e suddivide i requisiti in cinque categorie: ambiente, capitale sociale, leadership e governance, business model e innovazione, capitale umano.
        </p>
        
        <h4 className="text-xl font-semibold mb-2">2. Task Force on Climate-related Financial Disclosures (TCFD)</h4>
        <p className="mb-2 text-lg">Questo framework è stato progettato esplicitamente per affrontare i rischi climatici per l'azienda e si articola in quattro pilastri:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
        ...
        <h4 className="text-xl font-semibold mb-2">3. Integrated Reporting Framework (IRF)</h4>
        <p className="mb-6 text-lg">
          Sviluppato dall'International Integrated Reporting Council (IIRC), promuove un approccio che combina informazioni finanziarie e non finanziarie per fornire una visione olistica del valore creato dall'organizzazione. Considera sei tipi di capitale (finanziario, prodotto, umano, intellettuale, naturale e sociale) per una valutazione più completa.
        </p>
        
        <h3 className="text-2xl font-semibold mb-4">Sfide e soluzioni tecnologiche</h3>
        <p className="mb-6 text-lg">
          Un aspetto particolarmente critico dell'integrazione è la gestione dei dati ESG. A differenza dei dati finanziari, quelli ESG sono spesso ospitati in sistemi eterogenei e alcune organizzazioni tentano di gestire la contabilità annuale dei gas serra (GHG) utilizzando fogli di calcolo, pratica che crea notevoli rischi.
        </p>
        
        <p className="mb-2 text-lg">Le organizzazioni possono trarre vantaggio dall'implementazione di piattaforme software specializzate per:</p>
        <ul className="list-disc pl-8 mb-6 text-lg space-y-2">
