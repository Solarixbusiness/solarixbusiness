  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Calendario 2025-2026: Scadenze e Opportunità</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Come Strutturiamo le Vostre Candidature</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">I Nostri Servizi di Consulenza</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">La Nostra Strategia di Crescita per Voi</h2>
      ...
      {/* Errori da Evitare */}
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Errori che Vi Aiutiamo a Evitare</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">I Nostri Primi Passi Operativi</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Tempistiche di Erogazione Fondi</h2>
      ...
      {/* Chi Può Partecipare */}
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Chi Può Partecipare ai Nostri Progetti</h2>
