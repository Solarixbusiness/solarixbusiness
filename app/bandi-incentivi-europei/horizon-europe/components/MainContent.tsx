  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Introduzione</h2>
      ...
      {/* Obiettivi */}
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Obiettivi di Horizon Europe</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Requisiti di Partecipazione</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">I 6 Gruppi Tematici di Horizon Europe</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-green-700 mb-6">Budget e Finanziamenti Disponibili</h2>
