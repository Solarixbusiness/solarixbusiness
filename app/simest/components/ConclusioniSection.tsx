  ...
  return (
    <div className="mb-12">
      <div className="bg-white p-6 border border-green-100 rounded-lg shadow-lg">
        <h2 id="conclusioni" className="text-2xl font-semibold text-green-700 mb-6">24. CONCLUSIONI E CONTATTI</h2>
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-green-600 mb-4">Il Fondo 394/81: La Tua Porta d'Accesso ai Mercati Internazionali</h3>
          ...
          <div className="bg-green-50 p-6 rounded-lg mb-6">
            <h4 className="font-semibold text-green-700 mb-3">Perché Scegliere SolariX Business per il Tuo Progetto SIMEST</h4>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h5 className="font-semibold text-green-600 mb-2">Esperienza Consolidata</h5>
              ...
              <div>
                <h5 className="font-semibold text-green-600 mb-2">Servizio Completo</h5>
                <ul className="list-disc list-inside space-y-1 ml-2 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-green-600 mb-2">Efficienza e Rapidità</h5>
                <ul className="list-disc list-inside space-y-1 ml-2 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-green-600 mb-2">Massimizzazione dei Benefici</h5>
                <ul className="list-disc list-inside space-y-1 ml-2 text-sm">
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="text-center">
            <h4 className="text-xl font-semibold text-green-700 mb-4">Pronto a Trasformare la Tua Visione in Realtà?</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                href="/contatti" 
                className="inline-flex items-center justify-center bg-green-700 hover:bg-green-800 text-white py-3 px-6 rounded-lg font-semibold transition-colors"
              >
              ...
              <a 
                ...
                className="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-lg font-semibold transition-colors"
              >
