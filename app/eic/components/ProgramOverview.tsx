...
export default function ProgramOverview({ openSections, toggleSectionAction }: ProgramOverviewProps) {
  return (
    <>
      {/* Panoramica Programmi */}
      <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
        <button
          onClick={() => toggleSectionAction('panoramica')}
          className="w-full flex justify-between items-center text-left"
        >
          <h2 className="text-3xl font-bold text-purple-800">📋 I 4 Programmi EIC: Il Vostro Percorso di Crescita</h2>
          <span className="text-3xl text-purple-600">{openSections['panoramica'] ? '−' : '+'}</span>
        </button>
        
        {openSections['panoramica'] && (
          <div className="mt-6">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
        ...
        >
          ...
          <span className="text-3xl text-purple-600">{openSections['struttura'] ? '−' : '+'}</span>
        </button>
