...
interface CalendarProjectsProps {
  openSections: { [key: string]: boolean };
  toggleSectionAction: (sectionId: string) => void;
}

export default function CalendarProjects({ openSections, toggleSectionAction }: CalendarProjectsProps) {
  return (
    <>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
        ...
        >
          ...
          <span className="text-3xl text-purple-600">{openSections['calendario'] ? '−' : '+'}</span>
        </button>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
        ...
        >
          ...
          <span className="text-3xl text-purple-600">{openSections['progetti'] ? '−' : '+'}</span>
        </button>
