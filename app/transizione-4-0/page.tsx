...
const Parte1QuadroNormativo = dynamic(() => import('./components/Parte1QuadroNormativo'), {
  loading: () => <div className="animate-pulse bg-gray-200 h-96 rounded-lg"></div>
});

const Parte2BeniCrediti = dynamic(() => import('./components/Parte2BeniCrediti'), {
  loading: () => <div className="animate-pulse bg-gray-200 h-96 rounded-lg"></div>
});

const Parte3DocumentazioneControlli = dynamic(() => import('./components/Parte3DocumentazioneControlli'), {
  loading: () => <div className="animate-pulse bg-gray-200 h-96 rounded-lg"></div>
});
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <Suspense fallback={<div className="animate-pulse bg-gray-200 h-96 rounded-lg mb-8"></div>}>
