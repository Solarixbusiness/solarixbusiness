...
export default function ProjectPortfolio({ openSections, toggleSectionAction }: ProjectPortfolioProps) {
  return (
    <>
      {/* Esempi di Progetti */}
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <div 
          onClick={() => toggleSectionAction('esempi-progetti')}
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <div 
          onClick={() => toggleSectionAction('timeline')}
          className="cursor-pointer flex justify-between items-center mb-6"
        >
        ...
        {openSections['timeline'] && (
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl">
              <h3 className="text-2xl font-bold text-purple-800 mb-4">🗓️ Calendario Strategico per Massimizzare i Finanziamenti</h3>
