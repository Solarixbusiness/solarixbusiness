...
export default function InvestEUPage() {
  ...
  return (
    <>
      <SeoHead 
        title="InvestEU - Finanziamenti UE per Investimenti Sostenibili | SolariX Business"
        description="Accedi ai finanziamenti InvestEU con garanzie fino all'80% e tassi agevolati. Supportiamo PMI e grandi progetti per investimenti sostenibili e innovazione. Consulenza gratuita."
        keywords="InvestEU, finanziamenti UE, investimenti sostenibili, garanzie europee, prestiti agevolati, PMI, innovazione, energia rinnovabile"
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50">
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              { label: 'Home', path: '/' },
              { label: 'Finanziamenti UE', path: '/finanziamenti-ue' },
              { label: 'InvestEU', path: '/investeu' }
            ]} 
          />
